...
class DeployPySparkScriptOnAws(object):
    ...
    def __init__(self):
        ...
        self.user = 'mltrons'                               # Define user name

    def run(self):
        # session = boto3.Session(profile_name='431116953364')     # Select AWS IAM profile
    ...
    def step_spark_submit(self, c, arguments):
        ...
        logger.info("Added step 'spark-submit' with argument ")
